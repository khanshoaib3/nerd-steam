...
import com.github.khanshoaib3.nerdsteam.ui.screen.appdetail.toSerializableAppData
...
class CacheRepositoryTest {
    ...
    @Test
    fun `test data conversion`() {
        runBlocking {
            val response = cacheRepository.storeCachedData(example.toSerializableAppData())
//            Assert.assertTrue(response.isSuccess)
    ...
    private val example =
        AppData(
            steamAppId = 220,
            commonDetails = CommonAppDetails(
                name = "Half - Life 2",
                type = "game",
                imageUrl = "",
